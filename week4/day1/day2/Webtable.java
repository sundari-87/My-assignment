...
ChromeDriver driver=new ChromeDriver();
    ...
    //System.out.println(text);
     ...
     Set<String> duplicatetrainnames = new HashSet<>();
      for (int i = 2; i < rowsize.size(); i++) {
    	  WebElement trname=driver.findElement(By.xpath("//table[@class='DataTable TrainList TrainListHeader stickyTrainListHeader']/tbody/tr["+i+"]/td[2]"));
			...
			for (int j = i; j < rowsize.size(); j++) {
				...
				{
				WebElement anname = driver.findElement(By.xpath("//table[@class='DataTable TrainList TrainListHeader stickyTrainListHeader']/tbody/tr["+j+"]/td[2]"));
